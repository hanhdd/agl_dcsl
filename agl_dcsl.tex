...
\address[addressFE]{Department of Information Technology, Swinburne University of Technology Vietnam}
\ead{duclm20@fe.edu.vn}

\author[addressUET,addressVUTED]{Van-Vinh Le}
\address[addressVUTED]{Department of Information Technology, Vinh University of Technology Education, Vietnam}
\ead{levanvinh@vuted.edu.vn}
%
...
%
\input{contents/incorporateDomainBehavior}
...
%
%We wish to thank the anonymous reviewers for numerous insightful feedbacks on the first version of this paper.
