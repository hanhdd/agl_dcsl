...
\multicolumn{1}{|r|}{optional}          & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}jdo(ii).Column.allowsNull,\\ (Property.optionality)\end{tabular}}   & \multicolumn{1}{c|}{Required}                                                                                          & \multicolumn{1}{c|}{P3}       \\ \hline
...
\multicolumn{1}{|r|}{auto}              & \multicolumn{1}{c|}{-}                                                                                             & \multicolumn{1}{c|}{-(iii)}                                                                                            & \multicolumn{1}{c|}{P5}       \\ \hline
\multicolumn{1}{|r|}{length}            & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}jdo.Column.length,\\ (Property.maxLength)\end{tabular}}             & \multicolumn{1}{c|}{jpa(iv).Column.length}                                                                             & \multicolumn{1}{c|}{P6}       \\ \hline
\multicolumn{1}{|r|}{min}               & \multicolumn{1}{c|}{-}                                                                                             & \multicolumn{1}{c|}{Min(v).value}                                                                                      & \multicolumn{1}{c|}{P7}       \\ \hline
\multicolumn{1}{|r|}{max}               & \multicolumn{1}{c|}{-}                                                                                             & \multicolumn{1}{c|}{Max(v).value}                                                                                      & \multicolumn{1}{c|}{P8}       \\ \hline
...
\multicolumn{1}{|r|}{AGraph}            & \multicolumn{1}{c|}{-}                                                                                             & \multicolumn{1}{c|}{-}                                                                                                 &                               \\ \hline
\multicolumn{1}{|r|}{ANode}             & \multicolumn{1}{c|}{-}                                                                                             & \multicolumn{1}{c|}{-}                                                                                                 &                               \\ \hline
\multicolumn{1}{|r|}{MAct}              & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}defined by the controllers:\\ only CRUD and reporting\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}direct mapping from the domain\\ object model into the UI\end{tabular}} &                               \\ \hline
\end{tabular}
