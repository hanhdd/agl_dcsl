...
\begin{wrapfigure}{r}{11cm}
	\begin{center}
\vspace{-0.8cm}		\includegraphics[scale=0.4]{motivating-example2}
	\end{center}
\vspace{-0.5cm}
	\caption{A UML Activity diagram to represent the enrolment management activity.}
	\label{fig:motivatingExample2}
