...
\todo{Due to the limitation of the length of this paper, we only present the sequential pattern. The four remaining patterns are explained in the long version of this paper}

\footnote{\url{http://www.uet.vnu.edu.vn/~hanhdd/2022infsof/longVersion_agl_dcsl.pdf}}.
