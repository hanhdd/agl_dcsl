...
\begin{itemize}%[leftmargin=15pt]
	...
	\item[R2.] value specification is only applied to decision node.
	\item[X1.] using variable with activity.
	\item[X2.] variable action.
  \item[X3.] activity edge is without guards.
\end{itemize}
...
We define the abstract syntax of \agl~with a metamodel as shown in Figure~\ref{fig:agl-abstractSyntax}. The well-formedness OCL rules of this model are presented in Appendix A of the technical report\footnote{\url{https://tinyurl.com/AGLTechnical}} of this paper. %~\ref{apex:agl-rules}. 
