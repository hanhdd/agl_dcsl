...
In this paper, we propose a novel unified domain modeling method to tackle these. 
We view unified model as an extended domain model in a module-based software architecture (MOSA)~\cite{le_tree-based_2015, le_generative_2018} that we have recently developed for DDD.
...
\begin{itemize}[leftmargin=*]
	\item introduce a method to incorporate behavior aspects into domain model by defining precisely unified model in the context of MOSA;
	...
	\item specify an aDSL (named \agl) to represent domain behaviors for a unified model;
