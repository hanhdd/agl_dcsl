...
"~This aspect of validity reflect to what extent the operational measures that are studied really represent what the researcher have in mind and what is investigated according to the research questions"
In our case study, we have assumed that there are no misinterpretations of the process requirements that would lead to unsatisfactory Figure 10: The composition of the configured unified model in terms of the unified model and an activity
graph mode
