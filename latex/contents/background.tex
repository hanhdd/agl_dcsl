...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This section motivates our work by means of example and reviews the background concepts that form
the basis for our discussion in this paper.
%We will illustrate the concepts using a course management (CourseMan) software example.
