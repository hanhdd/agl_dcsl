...
\author[addressFE,addressHANU]{Duc Minh Le}
\address[addressFE]{Department of Information Technology, Swinburne Vietnam, FPT Univeristy}
\ead{duclm20@fe.edu.vn}
\address[addressHANU]{Faculty of Information Technology, Hanoi University, Vietnam}
...
\input{contents/casestudy}
%%%%%%%%%%%%%
\input{contents/tool1}
%%%%%%%%
%\input{contents/tool}
