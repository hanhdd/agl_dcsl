...
viewDesc=@ViewDesc(
    domainClassLabel="Domain User",
    formTitle="DomainUser Manager", 
...
public class ModuleDomainUser {
  @AttributeDesc(label="Domain User")
  private String title;

  @AttributeDesc(label="Full name",alignX=AlignmentX.Center)
  private String name;

  @AttributeDesc(label="Login",alignX=AlignmentX.Center)
  private String login;
  
  @AttributeDesc(label="password",alignX=AlignmentX.Center)
  private String password;
  
  /* v3.3: use list field for Roles 
  */
  @AttributeDesc(label="theRoles",
